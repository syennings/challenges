...
const firstAnimalStartingWithLetterG = animals.filter((animal) =>
...
const animalsSortedAlphabetically = animals.slice().sort((a, b) => a - b);
...
console.log(
  ...
  `${weightOfAllAnimalsInAfrica} kilos`
);

...
function logSeparator(seperator, excercise) {
  const separator = "---------";
  console.log(separator);
  console.log("Excercise: ", excercise);
}

logSeparator("Excercise 1:", 1);
// console.log("-------------");
...
let logText = "This text does not appear. Why?";
function logTextFunction() {
  console.log(logText);
}
...
// function logSeparator(separator, exercise) {
//   console.log(separator);

...
console.log("any hippos? : ", hippoExists);
...
console.log(
  "car starting from index five exists? : ",
...
const anyAnimalEndsWithLetterZ = animalStrings.find((element) =>
  element.endsWith("z")
);
...
// const sumOfAllAnimalCharacters = animalStrings.reduce((acc, current) => {
